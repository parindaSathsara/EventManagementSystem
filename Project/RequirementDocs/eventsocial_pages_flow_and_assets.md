...
- **Logo:** Centered, white + neon pink accent
- **Assets needed:**
...
> **Style:** High-contrast monochrome base with `#2563EB`, `#3B82F6`, `#FF2BD6`, and `#FF4DDA` accent gradients
...
> **Colors:** Match brand palette (white, `#2563EB`, `#FF2BD6`, `#FF4DDA`)
...
Color palette: Deep black (#000000), white (#FFFFFF), accent blue (#2563EB), neon pink (#FF2BD6), neon pink soft (#FF4DDA).
...
neon pink accent. Flat icon style. No text. 200x200.
```
...
**Booking Confetti:**
```
Abstract confetti burst with neon pink and blue particles on dark 
...
**For reaction emojis:**
```
Design a custom [EMOJI_TYPE] emoji in neon style. Glowing [#FF2BD6 neon pink / 
#FF4DDA neon pink soft] on dark background. Expressive, fun, event-themed. 
48x48 size. No text.
```
...
(#FF2BD6) and accent blue (#2563EB) gradient on deep black (#000000). 
...
(#FF2BD6) and accent blue (#2563EB) light blobs. Smooth, unfocused, no 

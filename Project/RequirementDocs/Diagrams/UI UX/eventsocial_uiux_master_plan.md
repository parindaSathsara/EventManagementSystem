...
- Accent Blue: `#2563EB`, Highlight Blue: `#3B82F6`
- Neon Pink: `#FF2BD6`, Neon Pink Soft: `#FF4DDA`
...
- Accent Blue (`#2563EB`): primary buttons + icons
- Highlight Blue (`#3B82F6`): active elements + selections
- Neon Pink (`#FF2BD6`): artist glow + event energy
- Neon Pink Soft (`#FF4DDA`): gradients + soft glow effects

### 3.2 Contrast and Accessibility Rules

Measured contrast observations:
- `#2563EB` on black: strong
- `#FF2BD6` on black: very strong
...
4. Primary CTA hierarchy:
   - First: accent blue background + white text
   - Second: neon pink accent background + black text

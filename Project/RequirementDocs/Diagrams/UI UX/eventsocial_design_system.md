...
- Accent Blue: `#2563EB` (buttons / icons)
- Highlight Blue: `#3B82F6` (active elements)
- Neon Pink: `#FF2BD6` (artist glow / events)
- Neon Pink Soft: `#FF4DDA` (gradients)
...
- `--neon-pink`: `#FF2BD6`
- `--neon-pink-soft`: `#FF4DDA`

UI whites:
- `--soft-white`: `#F3F4F6`
- `--light-white-glow`: `#E5E7EB`
...
1. Accent Blue (`#2563EB`) is for:
   - Primary buttons and icons
   - CTA actions
   - Focus rings on dark UI
2. Highlight Blue (`#3B82F6`) is for:
   - Active state chips/tabs
   - Active elements and selections
3. Neon Pink (`#FF2BD6`) is for:
   - Artist glow and event energy
   - Decorative highlights and gradients
4. Neon Pink Soft (`#FF4DDA`) is for:
   - Gradient transitions with Neon Pink
   - Soft glow effects
5. Never rely on color alone; pair with icon/text for status.
6. On white backgrounds:
   - Avoid using accent colors as body text

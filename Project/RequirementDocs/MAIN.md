...
2. Accent Blue: `#2563EB` (buttons / icons).
3. Highlight Blue: `#3B82F6` (active elements).
4. Neon Pink: `#FF2BD6` (artist glow / events).
5. Neon Pink Soft: `#FF4DDA` (gradients).
6. Soft White: `#F3F4F6` (secondary UI).
7. Light White Glow: `#E5E7EB` (neon edge highlight).
8. Use accents with accessibility-safe contrast.
...
- Theme must follow monochrome + accents #2563EB, #3B82F6, #FF2BD6, and #FF4DDA.
